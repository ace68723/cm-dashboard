...
angular.module('MetronicApp')
	.controller('RestaurantListController', ['$rootScope','$scope', 'settings','Restaurants',function($rootScope, $scope, settings,Restaurants) {
        ...
        $rootScope.settings.layout.pageSidebarClosed = true;
          ...
          // function RestaurantsCtrl(RestaurantListCtrl, Restaurants) {
           ...
           RestaurantListCtrl.GetItem=function(restaurant){
            ...
            RestaurantListCtrl.showitem.rd= restaurant.rd;
            ...
            RestaurantListCtrl.showitem.openhour= restaurant.openhour;
